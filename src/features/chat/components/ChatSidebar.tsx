            ...
            <div className="space-y-1">
              {visibleRecentChats.map((chat) => (
                <button
                  ...
                  type="button"
                  className={cn(
                    "focus-visible:ring-brand/30 mx-1 w-[calc(100%-0.5rem)] truncate rounded-xl px-5 py-3 text-left text-sm font-semibold transition-colors duration-150 focus-visible:ring-2 focus-visible:outline-none",
                    chat.active
                      ? "text-brand bg-white dark:bg-white/10"
